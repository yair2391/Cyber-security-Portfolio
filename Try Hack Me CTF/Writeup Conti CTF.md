...
CVE-2020-0796 – חולשת קריטית לביצוע קוד מרחוק (RCE) המכונה "SMBGhost", הקיימת בפרוטוקול התקשורת SMBv3 של מערכות ההפעלה Windows, ומאפשרת לתוקפים להריץ קוד ברמת הליבה (Kernel) של השרת.